...
public class EnsemblTool implements MCPTool {
    ...
    public EnsemblTool(String name, String description, Map<String, String> propertyDescriptions, 
    ...
    public JsonObject execute(JsonObject parameters) throws ToolExecutionException {
        ...
        try {
            ...
            throw new ToolExecutionException("Failed to execute Ensembl tool " + name, e);
        }
    }
}
