...
public class RxNormTool implements MCPTool {
    ...
    public RxNormTool(String name, String description, Map<String, String> propertyDescriptions, 
    ...
    public JsonObject execute(JsonObject parameters) throws ToolExecutionException {
        ...
        try {
            ...
            throw new ToolExecutionException("Failed to execute RxNorm tool " + name, e);
        }
    }
}
