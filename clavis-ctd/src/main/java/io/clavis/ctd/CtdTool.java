...
public class CtdTool implements MCPTool {
    ...
    public CtdTool(String name, String description, Map<String, String> propertyDescriptions, 
    ...
    public JsonObject execute(JsonObject parameters) throws ToolExecutionException {
        ...
        try {
            ...
            throw new ToolExecutionException("Failed to execute CTD tool " + name, e);
        }
    }
}
