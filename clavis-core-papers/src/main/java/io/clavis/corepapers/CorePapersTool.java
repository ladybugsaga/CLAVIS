...
public class CorePapersTool implements MCPTool {
    ...
    public CorePapersTool(String name, String description, Map<String, String> propertyDescriptions, 
    ...
    public JsonObject execute(JsonObject parameters) throws ToolExecutionException {
        ...
        try {
            ...
            throw new ToolExecutionException("Failed to execute CORE tool " + name, e);
        }
    }
}
