...
public class HmdbTool implements MCPTool {
    ...
    public HmdbTool(String name, String description, Map<String, String> propertyDescriptions, 
    ...
    public JsonObject execute(JsonObject parameters) throws ToolExecutionException {
        ...
        try {
            ...
            throw new ToolExecutionException("Failed to execute HMDB tool " + name, e);
        }
    }
}
