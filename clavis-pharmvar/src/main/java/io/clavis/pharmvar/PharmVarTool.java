...
public class PharmVarTool implements MCPTool {
    ...
    public PharmVarTool(String name, String description, Map<String, String> propertyDescriptions, 
    ...
    public JsonObject execute(JsonObject parameters) throws ToolExecutionException {
        ...
        try {
            ...
            // Result is expected to be a JSON string from client
            ...
            if (element.isJsonArray()) {
                ...
                response.addProperty("raw_result", result);
            }
            return response;
        } catch (Exception e) {
            throw new ToolExecutionException("Failed to execute PharmVar tool " + name, e);
        }
    }
}
