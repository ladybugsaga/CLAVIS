...
public class ZincTool implements MCPTool {
    ...
    public ZincTool(String name, String description, Map<String, String> propertyDescriptions, 
    ...
    public JsonObject execute(JsonObject parameters) throws ToolExecutionException {
        ...
        try {
            ...
            // Result could be a JSON array (for search) or object (for details)
            ...
            throw new ToolExecutionException("Failed to execute ZINC tool " + name, e);
        }
    }
}
