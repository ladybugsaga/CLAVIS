...
/**
 * Concrete MCPTool implementation for PubChem tools.
 */
public class PubChemTool implements MCPTool {
    ...
    public PubChemTool(String name, String description, Map<String, String> properties,
