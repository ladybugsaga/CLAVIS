...
public class OpenTargetsTool implements MCPTool {
    ...
    public OpenTargetsTool(String name, String description, Map<String, String> propertyDescriptions, 
    ...
    public JsonObject execute(JsonObject parameters) throws ToolExecutionException {
        ...
        try {
            ...
            throw new ToolExecutionException("Failed to execute Open Targets tool " + name, e);
        }
    }
}
