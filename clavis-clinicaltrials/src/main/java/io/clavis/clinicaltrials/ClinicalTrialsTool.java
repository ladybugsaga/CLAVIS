...
/**
 * Concrete MCPTool implementation for ClinicalTrials tools.
 */
public class ClinicalTrialsTool implements MCPTool {
    ...
    public ClinicalTrialsTool(String name, String description, Map<String, String> properties,
